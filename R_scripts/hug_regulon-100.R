...
hugo_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/hugo_p1e-100.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
hugo_regulon_100 <- aracne2regulon(hugo_adjfile, dset)
...
save(hugo_regulon_100, file = "hugo_regulon_100.RData")
