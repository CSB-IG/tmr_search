...
vaque_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Vaquerizas_p1e-100.adj")
print("adj loaded")
...
vaquerizas_regulon_100 <- aracne2regulon(vaque_adjfile, dset)
...
print("proced to Save Regulon Vaquerizas")
rm(list=to_clean,to_clean) #cleaning
save(vaquerizas_regulon_100, file = "./Rdatas/vaquerizas_regulon_100.RData")
