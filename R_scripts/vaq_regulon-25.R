...
vaque_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Vaquerizas_p1e-25.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
vaquerizas_regulon_25 <- aracne2regulon(vaque_adjfile, dset)
...
save(vaquerizas_regulon_25, file = "./Rdatas/vaquerizas_regulon_25.RData")
