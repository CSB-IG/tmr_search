...
ShA_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Shimoni_Alvarez_p1e-25.adj")
print("adj loaded")
...
ShA_regulon_25 <- aracne2regulon(ShA_adjfile, dset)
...
save(ShA_regulon_25, file = "./Rdatas/ShA_regulon_25.RData")
