...
vaque_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Vaquerizas_p1e-10.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
vaquerizas_regulon <- aracne2regulon(vaque_adjfile, dset)
...
save(vaquerizas_regulon, file = "vaquerizas_regulon.RData")
