...
ani_top100mrs_neighbors <- read.table(file="lists/p10/p10_ani_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
ani_top100mrs_neighbors <- ani_top100mrs_neighbors$V1

hugo_top100mrs_neighbors <- read.table(file="lists/p10/p10_hugo_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
hugo_top100mrs_neighbors <- hugo_top100mrs_neighbors$V1

sha_top100mrs_neighbors <- read.table(file="lists/p10/p10_sha_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
sha_top100mrs_neighbors <- sha_top100mrs_neighbors$V1


vaq_top100mrs_neighbors <- read.table(file="lists/p10/p10_vaq_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
...
write.table(ani_top100mrs_neighborstopTable,file='./lists/p10/p10_ani_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(hugo_top100mrs_neighborstopTable,file='./lists/p10/p10_hugo_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(sha_top100mrs_neighborstopTable,file='./lists/p10/p10_sha_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(vaq_top100mrs_neighborstopTable,file='./lists/p10/p10_vaq_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(all_top100mrs_neighborstopTable,file='./lists/p10/p10_all_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################