...
vaque_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Vaquerizas_p1e-75.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
vaquerizas_regulon_75 <- aracne2regulon(vaque_adjfile, dset)
...
save(vaquerizas_regulon_75, file = "./Rdatas/vaquerizas_regulon_75.RData")
