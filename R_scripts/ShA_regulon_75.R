...
ShA_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Shimoni_Alvarez_p1e-75.adj")
print("adj loaded")
...
ShA_regulon_75 <- aracne2regulon(ShA_adjfile, dset)
...
print("proced to Save Regulon ShA")
rm(list=to_clean,to_clean) #cleaning
save(ShA_regulon_75, file = "./Rdatas/ShA_regulon_75.RData")
