...
ShA_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Shimoni_Alvarez_p1e-100.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
ShA_regulon_100 <- aracne2regulon(ShA_adjfile, dset)
...
save(ShA_regulon_100, file = "ShA_regulon_100.RData")
