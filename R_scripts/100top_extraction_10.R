...
ShA_top100mrs_10 <- as.vector(summary(ShA_mrshadow_10,mrs=100)$Regulon)

hugo_top100mrs_10 <- as.vector(summary(hugo_mrshadow_10,mrs=100)$Regulon)

vaq_top100mrs_10 <- as.vector(summary(vaq_mrshadow_10,mrs=100)$Regulon)

ani_top100mrs_10 <- as.vector(summary(ani_mrshadow_10,mrs=100)$Regulon)

all_top100mrs_10 <- unique(c(ani_top100mrs_10,vaq_top100mrs_10,hugo_top100mrs_10,ShA_top100mrs_10))


exp_all_top100mrs_10 <- dset[all_top100mrs_10,]

all_top100mrs_10fit  = lmFit(exp_all_top100mrs_10, design)
all_top100mrs_10fit2 = contrasts.fit(all_top100mrs_10fit, cont.matrix)
all_top100mrs_10fit2 = eBayes(all_top100mrs_10fit2)

all_top100mrs_10topTable <- topTable(all_top100mrs_10fit2, coef=1, adjust = "fdr", n = length(all_top100mrs_10))

write.table(all_top100mrs_10topTable,file="./lists/p10/all_top100mrs_10_LfCh.txt",quote=FALSE,sep="\t")
###############################################################################################

exp_ShA_top100mrs_10 <- dset[ShA_top100mrs_10,]

ShA_top100mrs_10fit  = lmFit(exp_ShA_top100mrs_10, design)
ShA_top100mrs_10fit2 = contrasts.fit(ShA_top100mrs_10fit, cont.matrix)
ShA_top100mrs_10fit2 = eBayes(ShA_top100mrs_10fit2)

ShA_top100mrs_10topTable <- topTable(ShA_top100mrs_10fit2, coef=1, adjust = "fdr", n = length(ShA_top100mrs_10))

write.table(ShA_top100mrs_10topTable,file="./lists/p10/ShA_top100mrs_10_LfCh.txt",quote=FALSE,sep="\t")
###############################################################################################
exp_hugo_top100mrs_10 <- dset[hugo_top100mrs_10,]

hugo_top100mrs_10fit  = lmFit(exp_hugo_top100mrs_10, design)
hugo_top100mrs_10fit2 = contrasts.fit(hugo_top100mrs_10fit, cont.matrix)
hugo_top100mrs_10fit2 = eBayes(hugo_top100mrs_10fit2)

hugo_top100mrs_10topTable <- topTable(hugo_top100mrs_10fit2, coef=1, adjust = "fdr", n = length(hugo_top100mrs_10))

write.table(hugo_top100mrs_10topTable,file="./lists/p10/hugo_top100mrs_10_LfCh.txt",quote=FALSE,sep="\t")
###############################################################################################
exp_ani_top100mrs_10 <- dset[ani_top100mrs_10,]

ani_top100mrs_10fit  = lmFit(exp_ani_top100mrs_10, design)
ani_top100mrs_10fit2 = contrasts.fit(ani_top100mrs_10fit, cont.matrix)
ani_top100mrs_10fit2 = eBayes(ani_top100mrs_10fit2)

ani_top100mrs_10topTable <- topTable(ani_top100mrs_10fit2, coef=1, adjust = "fdr", n = length(ani_top100mrs_10))

write.table(ani_top100mrs_10topTable,file="./lists/p10/ani_top100mrs_10_LfCh.txt",quote=FALSE,sep="\t")
###############################################################################################
exp_vaq_top100mrs_10 <- dset[vaq_top100mrs_10,]

vaq_top100mrs_10fit  = lmFit(exp_vaq_top100mrs_10, design)
vaq_top100mrs_10fit2 = contrasts.fit(vaq_top100mrs_10fit, cont.matrix)
vaq_top100mrs_10fit2 = eBayes(vaq_top100mrs_10fit2)

vaq_top100mrs_10topTable <- topTable(vaq_top100mrs_10fit2, coef=1, adjust = "fdr", n = length(vaq_top100mrs_10))

write.table(vaq_top100mrs_10topTable,file="./lists/p10/vaq_top100mrs_10_LfCh.txt",quote=FALSE,sep="\t")
###############################################################################################

write.table(ShA_top100mrs_10,file="./lists/p10/p10_ShA_top100mrs.txt",quote=FALSE,sep="\t",row.names=F,col.names=F)
write.table(vaq_top100mrs_10,file="./lists/p10/p10_vaq_top100mrs.txt",quote=FALSE,sep="\t",row.names=F,col.names=F)
write.table(hugo_top100mrs_10,file="./lists/p10/p10_hugo_top100mrs.txt",quote=FALSE,sep="\t",row.names=F,col.names=F)
write.table(ani_top100mrs_10,file="./lists/p10/p10_ani_top100mrs.txt",quote=FALSE,sep="\t",row.names=F,col.names=F)
write.table(all_top100mrs_10,file="./lists/p10/p10_all_top100.txt",quote=FALSE,sep="\t",row.names=F,col.names=F)
