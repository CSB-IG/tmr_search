...
atfdb_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/AnimalTFDB_p1e-10.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
ani_regulon_10 <- aracne2regulon(atfdb_adjfile, dset)
...
save(ani_regulon_10, file = "./Rdatas/ani_regulon_10.RData")
