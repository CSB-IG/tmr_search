...
load("./validation_analisys/GSE4611/dset_GSE4611.Rdata")
...
adjfile <- file.path("/home/hachepunto/MARINa/validation_analisys/GSE4611/GSE4611_p1e-16.adj")
print("adj loaded")
...
GSE4611_regulon <- aracne2regulon(adjfile, dset)
...
print("proced to Save Regulon GSE4611")
#rm(list=to_clean,to_clean) #cleaning
save(GSE4611_regulon, file = "./validation_analisys/GSE4611/GSE4611_regulon.Rdata")
