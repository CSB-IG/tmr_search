...
vaque_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Vaquerizas_p1e-50.adj")
print("adj loaded")


# Regulon generation
print("proced to compute the regulon")
vaquerizas_regulon_50 <- aracne2regulon(vaque_adjfile, dset)
...
save(vaquerizas_regulon_50, file = "./Rdatas/vaquerizas_regulon_50.RData")
