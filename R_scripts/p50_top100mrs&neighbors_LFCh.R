...
ani_top100mrs_neighbors <- read.table(file="lists/p50/p50_ani_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
ani_top100mrs_neighbors <- ani_top100mrs_neighbors$V1
# El gen "FOXE1200856_x_at" no estaba en dset:
ani_top100mrs_neighbors <- ani_top100mrs_neighbors[-100]

hugo_top100mrs_neighbors <- read.table(file="lists/p50/p50_hugo_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
hugo_top100mrs_neighbors <- hugo_top100mrs_neighbors$V1
# El gen "FOXE1200856_x_at" no estaba en dset:
hugo_top100mrs_neighbors <- hugo_top100mrs_neighbors[-100]

sha_top100mrs_neighbors <- read.table(file="lists/p50/p50_sha_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
sha_top100mrs_neighbors <- sha_top100mrs_neighbors$V1
# el gen "FOXE1200856_x_at" y "ZNF816" no estaba en el "dset":
sha_top100mrs_neighbors <- sha_top100mrs_neighbors[c(-100, -4766)]


vaq_top100mrs_neighbors <- read.table(file="lists/p50/p50_vaq_top100mrs&neighbors.txt", stringsAsFactors = FALSE)
vaq_top100mrs_neighbors <- vaq_top100mrs_neighbors$V1
# El gen "FOXE1200856_x_at" no estaba en dset:
vaq_top100mrs_neighbors <- vaq_top100mrs_neighbors[-100]
...
table(hugo_top100mrs_neighbors[100] %in% row.names(dset))["FALSE"]
table(vaq_top100mrs_neighbors[100] %in% row.names(dset))["FALSE"]
...
write.table(ani_top100mrs_neighborstopTable,file='./lists/p50/p50_ani_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(hugo_top100mrs_neighborstopTable,file='./lists/p50/p50_hugo_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(sha_top100mrs_neighborstopTable,file='./lists/p50/p50_sha_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(vaq_top100mrs_neighborstopTable,file='./lists/p50/p50_vaq_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################
...
write.table(all_top100mrs_neighborstopTable,file='./lists/p50/p50_all_top100mrs&neighbors_LfCh.txt',quote=FALSE,sep='\t')
###############################################################################################