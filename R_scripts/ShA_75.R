...
load("./Rdatas/ShA_regulon_75.RData")
to_clean <- ls()
print("Source and data set loaded")

########  M A R I N A ######## 
print("proced to compute the master regulators")
ShA_mrs_75 <- marina(signature, ShA_regulon_75, nullmodel)


# Leading-edge analysis
ShA_mrs_75 <- ledge(ShA_mrs_75)

print("master regulators computed")

print(summary(ShA_mrs_75))

ShA_top100_75 <-summary(ShA_mrs_75,mrs=100)
write.table(ShA_top100_75,file = "./lists/ShA_top100mrs_75.txt",quote = FALSE, sep = "\t")

print("Top 100 Master Regulators saved in 'ShA_top100mrs_75.txt' file")

print("proced to Save (mrs)")
save.image("ShA_MARINa_75.RData")
...
# Shadow analysis
ShA_mrshadow_75 <- shadow(ShA_mrs_75, pval=25)
...
# Synergy analysis
ShA_mrs_75 <- marinaCombinatorial(ShA_mrs_75, regulators=25)
