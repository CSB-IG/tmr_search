...
atfdb_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/AnimalTFDB_p1e-100.adj")
print("adj loaded")
...
ani_regulon_100 <- aracne2regulon(atfdb_adjfile, dset)
...
print("proced to Save Regulon animal tfdb")
rm(list=to_clean,to_clean) #cleaning
save(ani_regulon_100, file = "./Rdatas/ani_regulon_100.RData")
