...
ani_top100mrs <- summary(ani_mrshadow_50,mrs=100)$MARINA.results$Regulon
ani_top100mrs <- as.vector(ani_top100mrs)

hugo_top100mrs <- summary(hugo_mrshadow_50,mrs=100)$MARINA.results$Regulon
hugo_top100mrs <- as.vector(hugo_top100mrs)

ShA_top100mrs <- summary(ShA_mrshadow_50,mrs=100)$MARINA.results$Regulon
ShA_top100mrs <- as.vector(ShA_top100mrs)

vaq_top100mrs <- summary(vaq_mrshadow_50,mrs=100)$MARINA.results$Regulon
...
# ani_top100mrs_ledges <- ani_mrshadow_50$ledge[which(names(ani_mrshadow_50$ledge) %in% ani_top100mrs)]
# hugo_top100mrs_ledges <- hugo_mrshadow_50$ledge[which(names(hugo_mrshadow_50$ledge) %in% hugo_top100mrs)]
# ShA_top100mrs_ledges <- ShA_mrshadow_50$ledge[which(names(ShA_mrshadow_50$ledge) %in% ShA_top100mrs)]
# vaq_top100mrs_ledges <- vaq_mrshadow_50$ledge[which(names(vaq_mrshadow_50$ledge) %in% vaq_top100mrs)]

ani_All_ledges <- unique(unlist(ani_mrshadow_50$ledge[ani_top100mrs]))
hugo_All_ledges <- unique(unlist(hugo_mrshadow_50$ledge[hugo_top100mrs]))
ShA_All_ledges <- unique(unlist(ShA_mrshadow_50$ledge[ShA_top100mrs]))
vaq_All_ledges <- unique(unlist(vaq_mrshadow_50$ledge[vaq_top100mrs]))
...
write.table(all_lg_topTable,file="./lists/p50/p50_top100mrs_ledges/p50_all_top100mrs_ledges_LFCh.txt",quote=FALSE,sep="\t")
...
write.table(ani_lg_topTable,file="./lists/p50/p50_top100mrs_ledges/p50_ani_top100mrs_ledges_LFCh.txt",quote=FALSE,sep="\t")
...
write.table(hugo_lg_topTable,file="./lists/p50/p50_top100mrs_ledges/p50_hugo_top100mrs_ledges_LFCh.txt",quote=FALSE,sep="\t")
...
write.table(ShA_lg_topTable,file="./lists/p50/p50_top100mrs_ledges/p50_sha_top100mrs_ledges_LFCh.txt",quote=FALSE,sep="\t")
...
write.table(vaq_lg_topTable,file="./lists/p50/p50_top100mrs_ledges/p50_vaq_top100mrs_ledges_LFCh.txt",quote=FALSE,sep="\t")
...
ani_top100mrs_shadowpairs <- ani_mrshadow_50$shadow[which(ani_mrshadow_50$shadow[,1] %in% ani_top100mrs),]
ani_top100mrs_shadowpairs <- unique(as.vector(ani_top100mrs_shadowpairs))

hugo_top100mrs_shadowpairs <- hugo_mrshadow_50$shadow[which(hugo_mrshadow_50$shadow[,1] %in% hugo_top100mrs),]
hugo_top100mrs_shadowpairs <- unique(as.vector(hugo_top100mrs_shadowpairs))

ShA_top100mrs_shadowpairs <- ShA_mrshadow_50$shadow[which(ShA_mrshadow_50$shadow[,1] %in% ShA_top100mrs),]
ShA_top100mrs_shadowpairs <- unique(as.vector(ShA_top100mrs_shadowpairs))

vaq_top100mrs_shadowpairs <- vaq_mrshadow_50$shadow[which(vaq_mrshadow_50$shadow[,1] %in% vaq_top100mrs),]
