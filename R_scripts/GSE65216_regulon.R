...
setwd("~/MARINa")
load("./validation_analisys/dset_GSE65216.Rdata")
...
adjfile <- file.path("/home/hachepunto/MARINa/validation_analisys/p7_GSE65216_hgu133a.adj")
print("adj loaded")
...
GSE65216_regulon_7 <- aracne2regulon(adjfile, dset)
...
print("proced to Save Regulon GSE65216")
#rm(list=to_clean,to_clean) #cleaning
save(GSE65216_regulon_7, file = "./validation_analisys/GSE65216_regulon_p7.Rdata")
