...
hugo_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/hugo_p1e-50.adj")
print("adj loaded")
...
hugo_regulon_50 <- aracne2regulon(hugo_adjfile, dset)
...
save(hugo_regulon_50, file = "./Rdatas/hugo_regulon_50.RData")
