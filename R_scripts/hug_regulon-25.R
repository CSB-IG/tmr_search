...
hugo_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/hugo_p1e-25.adj")
print("adj loaded")
...
hugo_regulon_25 <- aracne2regulon(hugo_adjfile, dset)
...
print("proced to Save Regulon Hugo")
rm(list=to_clean,to_clean) #cleaning
save(hugo_regulon_25, file = "./Rdatas/hugo_regulon_25.RData")
