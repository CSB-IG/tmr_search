...
ShA_adjfile <- file.path("/home/hachepunto/transfac_network/adjs_prunned/Shimoni_Alvarez_p1e-50.adj")
print("adj loaded")
...
ShA_regulon_50 <- aracne2regulon(ShA_adjfile, dset)
...
save(ShA_regulon_50, file = "./Rdatas/ShA_regulon_50.RData")
